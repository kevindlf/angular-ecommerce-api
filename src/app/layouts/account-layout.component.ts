    ...
    <nav style="padding: 10px; background-color: #f8f9fa; display: flex; justify-content: space-between; align-items: center;">
      ...
      <div style="display: flex; gap: 10px; align-items: center;">
        <a
          ...
          class="common-button"
          style="padding: 8px 12px; border-radius: 4px; cursor: pointer; background-color: #525151; color: white; border: none; display: inline-flex; align-items: center; text-decoration: none; margin-right: 8px;">
        ...
        <a
          ...
          class="common-button"
          style="padding: 8px 12px; border-radius: 4px; cursor: pointer; background-color: #525151; color: white; border: none; display: inline-flex; align-items: center; text-decoration: none;">
